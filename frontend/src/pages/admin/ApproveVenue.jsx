  ...
  const handleAction = async (action, venueId = selectedVenueId) => {
    ...
    try {
      ...
      const errorMessage =
        ...
        `${
          action === "approve" ? "Tasdiqlashda" : "Rad etishda"
        } xatolik yuz berdi`;
    ...
    <div className="max-w-7xl mx-auto p-4 sm:p-6">
      ...
      >
        ...
        <h1 className="text-2xl font-bold text-white">
          To'yxonalarni tasdiqlash paneli
        </h1>
      </motion.div>
        ...
        >
          <div>
            ...
            <h3 className="text-2xl font-bold text-yellow-500">
              {venueStats.statusCounts.pending}
            </h3>
          </div>
        ...
        >
          <div>
            ...
            <h3 className="text-2xl font-bold text-green-500">
              {venueStats.statusCounts.approved}
            </h3>
          </div>
        ...
        >
          <div>
            ...
            <h3 className="text-2xl font-bold text-red-500">
              {venueStats.statusCounts.rejected}
            </h3>
          </div>
          ...
          {selectedVenue ? (
            <div className="h-full flex flex-col">
                  ...
                  <div className="md:w-1/2 space-y-4">
                    <div>
                      ...
                      <p className="text-gray-400">
                        {selectedVenue.address || "Manzil ko'rsatilmagan"}
                      </p>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <div className="bg-[#1a1f2e] p-3 rounded-lg">
                        ...
                        <p className="text-white">
                          {selectedVenue.phone_number || "Ko'rsatilmagan"}
                        </p>
                      </div>
                      <div className="bg-[#1a1f2e] p-3 rounded-lg">
                      ...
                      <div className="bg-[#1a1f2e] p-3 rounded-lg">
                        ...
                        <p className="text-white">
                          {Number(selectedVenue.price_seat).toLocaleString(
                            "uz-UZ"
                          )}{" "}
                          so'm
                        </p>
                      ...
                      <div className="bg-[#1a1f2e] p-3 rounded-lg">
                        ...
                        <p className="text-white">
                          {selectedVenue.district?.name || "Ko'rsatilmagan"}
                        </p>
                      </div>
                    </div>
              ...
              <div className="p-4 border-t border-gray-700 flex flex-wrap gap-3">
                ...
                <button
                  ...
                  disabled={
                    actionLoading || selectedVenue.status === "approved"
                  }
                ...
                <button
                  ...
                  disabled={
                    actionLoading || selectedVenue.status === "rejected"
                  }
                  className={`flex-1 py-2 px-4 rounded-lg flex items-center justify-center gap-2 transition-colors ${
            ...
            <div className="h-full flex flex-col items-center justify-center p-6 text-center">
              ...
              <h3 className="text-xl font-semibold text-white mb-2">
                To'yxona tanlanmagan
              </h3>
              <p className="text-gray-400 max-w-md">
                Batafsil ma'lumotlarni ko'rish va tasdiqlash/rad etish uchun
                chap paneldan to'yxonani tanlang.
              </p>
            </div>
          )}
        </motion.div>
              ...
              <div className="h-64">
                <BarChartComponent
                  data={[
                    {
                      name: "Kutilmoqda",
                      value: venueStats.statusCounts.pending,
                      color: "#eab308",
                    },
                    {
                      name: "Tasdiqlangan",
                      value: venueStats.statusCounts.approved,
                      color: "#22c55e",
                    },
                    {
                      name: "Rad etilgan",
                      value: venueStats.statusCounts.rejected,
                      color: "#ef4444",
                    },
                  ]}
                />
              ...
              <div className="h-64">
                <BarChartComponent
                  data={[
                    {
                      name: "0-100",
                      value: venueStats.capacityRanges["0-100"],
                      color: "#3b82f6",
                    },
                    {
                      name: "101-300",
                      value: venueStats.capacityRanges["101-300"],
                      color: "#6366f1",
                    },
                    {
                      name: "301-500",
                      value: venueStats.capacityRanges["301-500"],
                      color: "#8b5cf6",
                    },
                    {
                      name: "501+",
                      value: venueStats.capacityRanges["501+"],
                      color: "#a855f7",
                    },
                  ]}
                />
              ...
              <div className="h-64">
                <BarChartComponent
                  data={[
                    {
                      name: "0-20k",
                      value: venueStats.priceRanges["0-20k"],
                      color: "#06b6d4",
                    },
                    {
                      name: "21k-50k",
                      value: venueStats.priceRanges["21k-50k"],
                      color: "#0ea5e9",
                    },
                    {
                      name: "51k-100k",
                      value: venueStats.priceRanges["51k-100k"],
                      color: "#2563eb",
                    },
                    {
                      name: "100k+",
                      value: venueStats.priceRanges["100k+"],
                      color: "#4f46e5",
                    },
                  ]}
                />
  ...
  return (
    <div className="h-full flex flex-col">
      <div className="flex-1 flex items-end">
        {data.map((item, i) => {
          const height =
            item.value === 0 ? 0 : Math.max((item.value / maxValue) * 100, 5);
          return (
            <div
              key={i}
